...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Export people",
            description = "Export a page of people in Xlsx or Csv",
            tags = {"People"},
            responses = {
                @ApiResponse(
                    description = "Success",
    ...
    @Operation(summary = "Export person data as PDF",
            description = "Export a specific person data in PDF",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Create people from import",
            description = "Create people from upload of Xlsx or Csv",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
