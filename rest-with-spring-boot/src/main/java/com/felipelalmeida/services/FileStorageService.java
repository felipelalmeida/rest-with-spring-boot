...
import com.felipelalmeida.config.FileStorageConfig;
import com.felipelalmeida.exception.FileNotFoundException;
...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file){
        ...
        try {
            ...
            logger.error("Could not store file " + fileName + ". Pleas try again!");
            throw new FileStorageException("Could not store file " + fileName + ". Pleas try again!", e);
        }
    }
