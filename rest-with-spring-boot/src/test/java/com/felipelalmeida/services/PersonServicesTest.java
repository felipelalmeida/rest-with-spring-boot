...
class PersonServicesTest {
    ...
    void findById() {
        ...
        assertNotNull(result.getLinks().stream()
                ...
                && link.getHref().endsWith("/api/perosn/v1/1")
                && link.getType().equals("GET"))
        );

        assertNotNull(result.getLinks().stream()
                .anyMatch(link -> link.getRel().value().equals("findAll")
                && link.getHref().endsWith("/api/perosn/v1/all")
                && link.getType().equals("GET"))
        );

        assertNotNull(result.getLinks().stream()
                .anyMatch(link -> link.getRel().value().equals("create")
                && link.getHref().endsWith("/api/perosn/v1")
    ...
    void findAll() {
        ...
        assertNotNull(personFour.getLinks().stream()
                .anyMatch(link -> link.getRel().value().equals("self")
                        && link.getHref().endsWith("/api/perosn/v1/4")
                        && link.getType().equals("GET"))
        );
        ...
        assertNotNull(personSeven.getLinks().stream()
                .anyMatch(link -> link.getRel().value().equals("self")
                        && link.getHref().endsWith("/api/perosn/v1/7")
                        && link.getType().equals("GET"))
        );
